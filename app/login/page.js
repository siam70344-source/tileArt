    ...
    <div style={{
      ...
      <div className="animate__animated animate__fadeInUp" style={{
        ...
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: "2rem", color: "#f0ebe3", marginBottom: "0.5rem" }}>Welcome Back</h1>
          <p style={{ color: "#8a7f74", fontSize: "0.9rem" }}>Sign in to your TileArt account</p>
        </div>
        ...
        <p style={{ textAlign: "center", color: "#8a7f74", fontSize: "0.85rem", marginTop: "1.5rem" }}>
          ...
          <Link href="/register" style={{ color: "#c9a96e" }}>Register here</Link>
        </p>
      </div>
    </div>
  );
